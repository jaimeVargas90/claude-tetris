...
/**
 * Game detail screen — ported from legacy detalle.jsx.
 * Scores are computed server-side (seededScores is pure/deterministic)
 * and passed in as props instead of recomputed via useMemo.
 */
export function GameDetail({ game, scores }: GameDetailProps) {
