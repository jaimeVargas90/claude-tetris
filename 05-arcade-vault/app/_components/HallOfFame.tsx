...
/**
 * Hall of Fame screen — ported from legacy salon.jsx.
 * Per-game tab state, fake leaderboard via seededScores, synthetic
 * "your rank" row appended when a session exists.
 */
